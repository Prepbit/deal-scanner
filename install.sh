...
echo "📦 Installing Hedge Fund Scanner v2..."

cd ~/deal-scanner

# system deps
pip3 install feedparser requests yfinance
...
echo "✅ Bot installed"
echo "👉 Next: export TELEGRAM_TOKEN + TELEGRAM_CHAT_ID"
echo "👉 Then run: python3 bot.py"
